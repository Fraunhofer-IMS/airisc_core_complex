...
set_property -dict {PACKAGE_PIN B22 IOSTANDARD LVCMOS12} [get_ports EXT_INT]
...
set_property -dict {PACKAGE_PIN E22 IOSTANDARD LVCMOS12} [get_ports {gpio_i[0]}]
set_property -dict {PACKAGE_PIN F21 IOSTANDARD LVCMOS12} [get_ports {gpio_i[1]}]
set_property -dict {PACKAGE_PIN G21 IOSTANDARD LVCMOS12} [get_ports {gpio_i[2]}]
set_property -dict {PACKAGE_PIN G22 IOSTANDARD LVCMOS12} [get_ports {gpio_i[3]}]
set_property -dict {PACKAGE_PIN H17 IOSTANDARD LVCMOS12} [get_ports {gpio_i[4]}]
set_property -dict {PACKAGE_PIN J16 IOSTANDARD LVCMOS12} [get_ports {gpio_i[5]}]
set_property -dict {PACKAGE_PIN K13 IOSTANDARD LVCMOS12} [get_ports {gpio_i[6]}]
set_property -dict {PACKAGE_PIN M17 IOSTANDARD LVCMOS12} [get_ports {gpio_i[7]}]
...
## Pmod header JA
## labor
#set_property -dict { PACKAGE_PIN AB22  IOSTANDARD LVCMOS33 } [get_ports { jtag_tdo }]; #IO_L10N_T1_D15_14 Sch=ja[1]
#set_property -dict { PACKAGE_PIN AB21  IOSTANDARD LVCMOS33 } [get_ports { jtag_tck }]; #IO_L10P_T1_D14_14 Sch=ja[2]
#set_property -dict { PACKAGE_PIN AB20  IOSTANDARD LVCMOS33 } [get_ports { jtag_tms }]; #IO_L15N_T2_DQS_DOUT_CSO_B_14 Sch=ja[3]
#set_property -dict { PACKAGE_PIN AB18  IOSTANDARD LVCMOS33 } [get_ports { jtag_tdi }]; #IO_L17N_T2_A13_D29_14 Sch=ja[4]

###########################################################Test SPI###########################################################
#set_property -dict {PACKAGE_PIN W20 IOSTANDARD LVCMOS33} [get_ports spi_mosi]
#set_property -dict {PACKAGE_PIN W19 IOSTANDARD LVCMOS33} [get_ports spi_sclk]
#set_property -dict {PACKAGE_PIN T18 IOSTANDARD LVCMOS33} [get_ports spi_nss]
#set_property -dict {PACKAGE_PIN V19 IOSTANDARD LVCMOS33} [get_ports spi_miso]

#set_property -dict { PACKAGE_PIN AA21  IOSTANDARD LVCMOS33 } [get_ports { sd_reset }]; #IO_L8N_T1_D12_14 Sch=ja[8]
##############################################################################################################################

## zuhause
# spi sclk is mapped to arbitrary pin, because the SPI interface is used for the QSPI flash, 
# and SCLK is accessed through the STARTUPE2 primitive.
#set_property -dict { PACKAGE_PIN AB22  IOSTANDARD LVCMOS33 } [get_ports { spi_sclk }]; #IO_L10N_T1_D15_14 Sch=ja[1]

#set_property -dict { PACKAGE_PIN AB22  IOSTANDARD LVCMOS33 } [get_ports { ja[0] }]; #IO_L10N_T1_D15_14 Sch=ja[1]

#set_property -dict { PACKAGE_PIN AB21  IOSTANDARD LVCMOS33 } [get_ports { jtag_tms }]; #IO_L10P_T1_D14_14 Sch=ja[2]
#set_property -dict { PACKAGE_PIN AB21  IOSTANDARD LVCMOS33 } [get_ports { ja[1] }]; #IO_L10P_T1_D14_14 Sch=ja[2]

#set_property -dict { PACKAGE_PIN AB20  IOSTANDARD LVCMOS33 } [get_ports { jtag_tdi }]; #IO_L15N_T2_DQS_DOUT_CSO_B_14 Sch=ja[3]
#set_property -dict { PACKAGE_PIN AB20  IOSTANDARD LVCMOS33 } [get_ports { ja[2] }]; #IO_L15N_T2_DQS_DOUT_CSO_B_14 Sch=ja[3]

#set_property -dict { PACKAGE_PIN AB18  IOSTANDARD LVCMOS33 } [get_ports { jtag_tdo }]; #IO_L17N_T2_A13_D29_14 Sch=ja[4]
...
#set_property -dict { PACKAGE_PIN V9    IOSTANDARD LVCMOS33 } [get_ports { gpio_d[0] }]; #IO_L21P_T3_DQS_34 Sch=jb_p[1]

#set_property -dict { PACKAGE_PIN V8    IOSTANDARD LVCMOS33 } [get_ports { jb[1] }]; #IO_L21N_T3_DQS_34 Sch=jb_n[1]
#set_property -dict { PACKAGE_PIN V8    IOSTANDARD LVCMOS33 } [get_ports { gpio_d[1] }]; #IO_L21N_T3_DQS_34 Sch=jb_n[1]

#set_property -dict { PACKAGE_PIN V7    IOSTANDARD LVCMOS33 } [get_ports { jb[2] }]; #IO_L19P_T3_34 Sch=jb_p[2]
#set_property -dict { PACKAGE_PIN V7    IOSTANDARD LVCMOS33 } [get_ports { gpio_d[2] }]; #IO_L19P_T3_34 Sch=jb_p[2]

#set_property -dict { PACKAGE_PIN W7    IOSTANDARD LVCMOS33 } [get_ports { jb[3] }]; #IO_L19N_T3_VREF_34 Sch=jb_n[2]
#set_property -dict { PACKAGE_PIN W7    IOSTANDARD LVCMOS33 } [get_ports { gpio_d[3] }]; #IO_L19N_T3_VREF_34 Sch=jb_n[2]

#set_property -dict { PACKAGE_PIN W9    IOSTANDARD LVCMOS33 } [get_ports { jb[4] }]; #IO_L24P_T3_34 Sch=jb_p[3]
#set_property -dict { PACKAGE_PIN W9    IOSTANDARD LVCMOS33 } [get_ports { gpio_d[4] }]; #IO_L24P_T3_34 Sch=jb_p[3]

#set_property -dict { PACKAGE_PIN Y9    IOSTANDARD LVCMOS33 } [get_ports { jb[5] }]; #IO_L24N_T3_34 Sch=jb_n[3]
#set_property -dict { PACKAGE_PIN Y9    IOSTANDARD LVCMOS33 } [get_ports { gpio_d[5] }]; #IO_L24N_T3_34 Sch=jb_n[3]

#set_property -dict { PACKAGE_PIN Y8    IOSTANDARD LVCMOS33 } [get_ports { jb[6] }]; #IO_L23P_T3_34 Sch=jb_p[4]
#set_property -dict { PACKAGE_PIN Y8    IOSTANDARD LVCMOS33 } [get_ports { gpio_d[6] }]; #IO_L23P_T3_34 Sch=jb_p[4]

#set_property -dict { PACKAGE_PIN Y7    IOSTANDARD LVCMOS33 } [get_ports { jb[7] }]; #IO_L23N_T3_34 Sch=jb_n[4]
#set_property -dict { PACKAGE_PIN Y7    IOSTANDARD LVCMOS33 } [get_ports { gpio_d[7] }]; #IO_L23N_T3_34 Sch=jb_n[4]
...
set_property -dict {PACKAGE_PIN T19 IOSTANDARD LVCMOS33} [get_ports spi_nss]
...
#set_property -dict { PACKAGE_PIN P21   IOSTANDARD LVCMOS33 } [get_ports { spi_nwp }]; #IO_L2P_T0_D02_14 Sch=qspi_dq[2]

#set_property -dict { PACKAGE_PIN R21   IOSTANDARD LVCMOS33 } [get_ports { spi_nhld }]; #IO_L2N_T0_D03_14 Sch=qspi_dq[3]
